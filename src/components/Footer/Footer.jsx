        ...
        <div className="container">
            <div className="footer__body">
                <div className="footer__connect">
                    ...
                    <p className="footer__connect_email">
                ...
                <ul className="footer__help footer-navigation">
                    <li className="footer-navigation__item">
                        <a href="#"
                           className="footer-navigation__item_link">Доставка</a>
                    </li>
                    <li className="footer-navigation__item">
                    ...
                    <li className="footer-navigation__item">
                        <a href="#"
                           className="footer-navigation__item_link">Помощь</a>
                    </li>
                    <li className="footer-navigation__item">
                        <a href="#"
                           className="footer-navigation__item_link">Больше о нас</a>
                    </li>
                </ul>
            </div>
        </div>
